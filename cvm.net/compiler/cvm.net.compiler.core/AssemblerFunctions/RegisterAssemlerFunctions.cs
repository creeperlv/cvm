...
namespace cvm.net.compiler.core.AssemblerFunctions
{
    public static unsafe class RegisterAssemlerFunctions
    {
        ...
        public unsafe static bool Assemble_COMP(ushort instID, Segment s, OperationResult<CVMObject> result, nint InstPtr, int PC)
        {
        ...
        public unsafe static bool Assemble_SH(ushort instID, Segment s, OperationResult<CVMObject> result, nint InstPtr, int PC)
        {
            switch (instID)
            {
                case InstID.SH:
        ...
        public unsafe static bool Assemble_SET(ushort instID, Segment s, OperationResult<CVMObject> result, nint InstPtr, int PC)
        {
            int Offset = 4;
            switch (instID)
            {
