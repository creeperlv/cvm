...
namespace cvm.net.compiler.core.AssemblerFunctions
{
    ...
    {
        public unsafe static bool Assemble_LRCalc(ushort instID, Segment s, OperationResult<CVMObject> result, nint InstPtr, int PC)
        {
        ...
        public unsafe static bool Assemble_SCalc(ushort instID, Segment s, OperationResult<CVMObject> result, nint InstPtr, int PC)
        {
        ...
        public unsafe static bool Assemble_CVT(ushort instID, Segment s, OperationResult<CVMObject> result, nint InstPtr, int PC)
        {
        ...
        public unsafe static bool Assemble_BasicMath(ushort instID, Segment s, OperationResult<CVMObject> result, nint InstPtr, int PC)
        {
            switch (instID)
            {
                case InstID.ADD:
