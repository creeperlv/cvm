...
namespace cvm.net.assembler.core
{
	public static unsafe class JumpAssemlerFunctions
	{
		...
		public unsafe static bool Assemble_PJMP(ushort instID, Segment s, OperationResult<CVMObject> result, IntPtr InstPtr, int PC)
		{
		...
		public unsafe static bool Assemble_CALL(ushort instID, Segment s, OperationResult<CVMObject> result, IntPtr InstPtr, int PC)
		{
